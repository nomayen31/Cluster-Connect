...
const Navbar = () => {
  ...
  console.log(user);  // Debugging the user object to check if photoURL and displayName exist

  return (
    <nav className={`bg-[${styles.deepGreen}] text-white p-4 border-b border-gray-700 relative z-20 `}>
